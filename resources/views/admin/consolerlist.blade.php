...
<div class="container-fluid">
    ...
    <a href="{{ route('consolers.create') }}" class="btn btn-primary border-0" style="background-color: #5271FF;">Add Consoler</a>
</div>

        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-borderless " id="dataTable" width="100%" cellspacing="0">
                    <thead style="pointer-events: none; user-select: none; background-color:#5271FF; color:#FFFFFF">
                        <tr>
                            <th>Name</th>
                            <th>Email</th>
                            <th>Console Name</th>
